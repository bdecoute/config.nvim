...
require('lazy').setup({
  ...
  -- TODO: check out benfowler/telescope-luasnip.nvim
  -- TODO: Setup my own lua snippets from $MYVIMRC/LuaSnip/ using https://github.com/L3MON4D3/LuaSnip/blob/master/DOC.md#lua
  --
  { -- Autocompletion
    'hrsh7th/nvim-cmp',
    event = 'InsertEnter',
